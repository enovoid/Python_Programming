...
# List Comprehension vd Generator
...
print(f"최대 점수: {result[0]}점, 최소 점수: {result[len(scores) - 1]}점")
...
# 총 재고 금액 출력
print(sum(price * quantity for name, price, quantity in stocks), "원")
